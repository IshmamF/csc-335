...
;cond ((symbol? exp) (do-something))
;     ((check-lambda exp) (recurse-through-body))
;     (else (recurse-through-each))

; Idea: Remove all the bound variables, so we're left with free variables
