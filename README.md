...
- For project, unless told to do so explicitly, avoid iterative solutions (I didn't attend class and it wasn't explicit that he didn't want iterative so lost points)

## Resources
- for writing proofs, look at how_to_write_proofs.md 
  - also reference previous exams + project to see examples
- to understand recursion, refer to this article i wrote https://medium.com/@ishmamf/how-to-understand-recursion-and-apply-it-0231aefc4986
